...
Route::post('/find/search', 'Frontend\FrontendController@findSearch')->name('find.search');
...
Route::group(['middleware'=>['auth','admin']],function(){
	...
	Route::prefix('company')->group(function(){
		Route::get('/view', 'Backend\CompanyController@view')->name('company.view');
		Route::get('/add', 'Backend\CompanyController@add')->name('company.add');
		Route::post('/store', 'Backend\CompanyController@store')->name('company.store');
		Route::get('/edit/{id}', 'Backend\CompanyController@edit')->name('company.edit');
		Route::post('/update/{id}', 'Backend\CompanyController@update')->name('company.update');
		Route::get('/delete/{id}', 'Backend\CompanyController@delete')->name('company.delete');
	});
