...
<div class="dis-none panel-search w-full p-t-10 p-b-15">
    <div class="bor8 dis-flex p-l-15">
        <form action="{{route('find.product')}}" method="post">
            ...
            <input class="mtext-107 cl2 size-114 plh2 p-r-15" type="text" name="slug" id="slug" placeholder="Write product name" style="width: 100%;" autocomplete="off">
        </form>
    </div>
    <div class="col-md-5" id="productStatus"></div>
</div>
