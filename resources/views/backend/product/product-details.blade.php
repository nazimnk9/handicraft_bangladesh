                ...
                <table class="table table-bordered table-hover table-sm">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="50%">
                                <img src="{{(!empty($product->image))?url('public/upload/product_images/'.$product->image):url('public/upload/no_image.png')}}" style="width: 100px; height: 105px;">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td width="50%">
                                ...
                                <img src="{{url('public/upload/product_images/product_sub_images/'.$img->sub_image)}}" style="width: 100px; height: 105px;">
                                @endforeach
                            </td>
                        </tr>
                    </tbody>
